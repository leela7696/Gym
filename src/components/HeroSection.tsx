...
const HeroSection = () => (
  <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
    ...
    <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,hsl(347_77%_50%/0.15),transparent_60%)]" />
    ...
    <div className="relative z-10 container mx-auto px-4 text-center space-y-8">
      ...
      <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
        Transform Your Body at Shripallavi Fitness and Gym
      </p>
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        ...
        <Button size="lg" variant="secondary" asChild className="text-base px-8">
          <a href="tel:09888345345"><Phone size={18} className="mr-2" />Call Now</a>
        </Button>
      </div>
    </div>
  </section>
